...
class TarefaAdapter : RecyclerView.Adapter<TarefaAdapter.TarefaViewHolder>(){
    ...
    override fun onBindViewHolder(holder: TarefaViewHolder, position: Int) {
        ...
        //Como alteramos a classe de modelo, precisamos alterar aqui tbm.
        /*
        Como categoria não é mais uma string, precisamos retornar, na verdade, o atributo descricao
         desse objeto, portanto substituiremos essa linha por
         */
